                            ...
                            <tr>
                                ...
                                @if (count($users))
                                    <td class="px-6 py-4 text-sm font-medium flex">
                                        ...
                                        <a class="ml-2 font-bold text-white py-2 px-4 rounded cursor-pointer bg-red-600 hover:bg-red-500" wire:click="$emit('alert_delete_user', {{$item->id}})">
        ...
        <x-slot name="content">
            <div>        
                <div class="mb-4">
                    ...
                    <x-jet-input type="text" required disabled class="w-full" wire:model="user.name"/>
                    <x-jet-input-error for="user.name"/>
                </div>
                
                <div class="mb-4">
                    <x-jet-label value="Correo del usuario"/>
                    <x-jet-input type="email" required disabled class="w-full" wire:model="user.email"/>
                    <x-jet-input-error for="user.email"/>
                </div>

                <div class="mb-4">
                    <x-jet-label value="Rol del Usuario"/>
                    <select wire:model="role" required class="w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">
