                            ...
                            <tr>
                                ...
                                @if (count($types))
                                    <td class="px-6 py-4 text-sm font-medium flex">
                                        ...
                                        <a class="ml-2 font-bold text-white py-2 px-4 rounded cursor-pointer bg-red-600 hover:bg-red-500" wire:click="$emit('alert_delete_type', {{$item->id}})">
        ...
        <x-slot name="content">
            <div>        
                <div class="mb-4">
                    ...
                    <x-jet-input type="text" required class="w-full" wire:model="type.nombre"/>
                    <x-jet-input-error for="type.nombre"/>
                </div>
                
                <div class="mb-4">
                    <x-jet-label value="Descripción del Tipo"/>
                    <textarea rows="6" required wire:model="type.descripcion" class="block w-full h-40 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"></textarea>
                    <x-jet-input-error for="type.descripcion"/>
                </div>
            </div>
        </x-slot>
        <x-slot name="footer">
